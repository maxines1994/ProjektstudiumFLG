from gtapp.views.stdViews import home_view, tasks_view, tasks_list_assigned_view,tasks_edit,tasks_finish, tasks_list_notassigned_view, tasks_list_finished_view, tasks_assign_to_me_view, Tasks_detail_view, tasks_assign_to_me_view, tasks_share_to_team_view
