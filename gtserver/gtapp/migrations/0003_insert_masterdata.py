...
class Migration(migrations.Migration):
    ...
    def insert_tasktypes(apps, schema_editor):
        ...
        TaskType.objects.create(id=24   , title = "Bestellreklamation versenden"                , description ="Bitte versenden Sie die Bestellreklamation."                                                                                                                , status_model = CustComplaint.__name__     , task_model= CustComplaint.__name__    , status=CustComplaint.Status.IN_REKLAMATION                    , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K1))
        TaskType.objects.create(id=25   , title = "Bestellreklamation versenden"                , description ="Bitte versenden Sie die Bestellreklamation."                                                                                                                , status_model = CustComplaint.__name__     , task_model= CustComplaint.__name__    , status=CustComplaint.Status.IN_REKLAMATION                    , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K2))
        TaskType.objects.create(id=26   , title = "Bestellreklamation versenden"                , description ="Bitte versenden Sie die Bestellreklamation."                                                                                                                , status_model = CustComplaint.__name__     , task_model= CustComplaint.__name__    , status=CustComplaint.Status.IN_REKLAMATION                    , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K3))
        TaskType.objects.create(id=27   , title = "Bestellreklamation an Produktion senden"     , description ="Bitte versenden Sie die den Hubwagen an die Produktion. tragen sie die Boxnummer ein."                                                                      , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.BEI_KUNDENDIENST               , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=KUNDENDIENST)                , for_all_details=True)
        TaskType.objects.create(id=28   , title = "Reklamation bearbeiten"                      , description ="Bitte bearbeiten Sie die Reklamation."                                                                                                                      , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.IN_ANPASSUNG                   , view_url = 'manufacturing_list'      , view_kwargs_id = ''                   , group=Group.objects.get(name=PRODUKTION))
        TaskType.objects.create(id=29   , title = "Boxnummer eintragen"                         , description ="Bitte tragen Sie die Boxnummer in die Reklamation ein und senden Sie die den Hubwagen an den Kundendienst"                                                  , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.ANPASSUNG_ABGESCHLOSSEN        , view_url = 'manufacturing_list'      , view_kwargs_id = ''                   , group=Group.objects.get(name=PRODUKTION))
        ...
        TaskType.objects.create(id=33   , title = "Bestellreklamation versenden"                , description ="Bitte tragen Sie die Boxnumemr ein.Bitte schreiben Sie eine Mail an den Lieferanten und versenden die Bestellreklamation"                                   , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=SuppComplaint.Status.IN_REKLAMATION                    , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG))
        TaskType.objects.create(id=34   , title = "Bestellreklamtion an Lieferant weitersenden" , description ="Bitte stun Sie die Teile in die entsprechende Lieferantenbox und senden Sie diese an den Lieferanten"                                                       , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=SuppComplaint.Status.BEI_PDL                           , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG))
