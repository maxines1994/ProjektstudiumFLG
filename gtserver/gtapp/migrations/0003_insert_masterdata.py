...
class Migration(migrations.Migration):
    ...
    def insert_tasktypes(apps, schema_editor):
        ...
        TaskType.objects.create(id=5    , title = "Kommissionieren für Produktion"                , description ='Bitte senden Sie die Teile an die Produktion. Wählen Sie bei dem entsprechenden Fertigungsauftrag den Button <a href= "/faq/12/">"Ware an Produktion liefern"</a>. <a href= "/faq/4/">Scannen</a> Sie den Barcode der Box und <a href= "/faq/15/">kommissionieren</a> Sie die entsprechenden A-Teile. Tipp: Merken Sie sich die Referenznummer.'                                                                                                                                                           , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN     , view_url = 'manufacturing_list'      , view_kwargs_id = ''                   , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG))
        ...
        TaskType.objects.create(id=7    , title = "Hubwagen an Kundendienst senden"           , description ='Bitte liefern Sie den Hubwagen an den Kundendienst. Dafür wählen Sie den Button <a href= "/faq/12/">"An KD ausliefern"</a> und <a href= "/faq/4/">scannen</a> anschließend den Barcode des Hubwagens ein. Tipp: Merken Sie sich die Referenznummer.'                                                                                                                                                                                                                                                         , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.LIEFERUNG_AN_KD_AUSSTEHEND         , view_url = 'manufacturing_list'      , view_kwargs_id = ''                   , group=Group.objects.get(name=PRODUKTION))
        TaskType.objects.create(id=8    , title = "Hubwagen an Kunden liefern"                 , description ='Bitte liefern Sie den Hubwagen an den Kunden. Wählen Sie dafür den Button <a href= "/faq/7/">"An Kunde liefern"</a> bei der entsprechenden Auftragsposition aus. <a href= "/faq/4/">Scannen</a> Sie den Barcode an dem Hubwagen ein. Schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an den Kunden mit der <a href= "/faq/20/">Referenznummer</a> und der Nummer an dem Hubwagen, damit dieser den Hubwagen zurordnen kann. Erkundigen Sie sich beim Kunden, ob der Hubwagen zufriedenstellend ist, um den Auftrag <a href= "/faq/7/">abzuschließen</a>.'      , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.LIEFERUNG_AN_K_AUSSTEHEND          , view_url = 'cust_order_alter'        , view_kwargs_id = 'cust_order_id'      , group=Group.objects.get(name=KUNDENDIENST))
        ...
        TaskType.objects.create(id=10   , title = "Kunde beliefern"                             , description ='Bitte beliefern Sie den Kunden. <a href= "/faq/4/">Scannen</a> Sie dafür den Barcode und <a href= "/faq/15/">kommissionieren</a> Sie die bestellten Teile. Schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an die Produktionsdienstleistung des Kunden, welche Bestellung sich in welcher Box befindet. Denken Sie an die <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Bestellung in seinem System zuweisen kann.'                                                                       , status_model = SuppOrder.__name__         , task_model= SuppOrder.__name__        , status=SuppOrder.Status.LIEFERUNG_AN_JOGA_AUSSTEHEND          , view_url = 'supp_order_alter'        , view_kwargs_id = 'supp_order_id'      , group=Group.objects.get(name=L300))

        #Bestellung Kunde 1, 2, 3, Joga 
        TaskType.objects.create(id=11   , title = "Qualitätsprüfung"                            , description ='Führen Sie eine Qualitätsprüfung des Hubwagens durch. Wählen Sie den Button <a href= "/faq/02/">"Abnehmen"</a> bei der Bestellposition aus, um im System den Wareneingang zu vermerken. Bei einer nicht erfolgreichen Qualitätsprüfung legen Sie außerdem eine <a href= "/faq/17/">Bestellreklamation</a> an.'                                                                                                                                                                                                                       , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.GELIEFERT                          , view_url = 'cust_order_alter'        , view_kwargs_id = 'cust_order_id'      , group=Group.objects.get(name=K1))
        TaskType.objects.create(id=12   , title = "Wareneingang buchen"                         , description='Führen Sie eine Qualitätsprüfung des Hubwagens durch. Wählen Sie den Button <a href= "/faq/02/">"Abnehmen"</a> bei der Bestellposition aus, um im System den Wareneingang zu vermerken. Bei einer nicht erfolgreichen Qualitätsprüfung legen Sie außerdem eine <a href= "/faq/17/">Bestellreklamation</a> an.'                                                                                                                                                                                                                       , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.GELIEFERT                          , view_url = 'cust_order_alter'        , view_kwargs_id = 'cust_order_id'      , group=Group.objects.get(name=K2))
        TaskType.objects.create(id=13   , title = "Wareneingang buchen"                         , description='Führen Sie eine Qualitätsprüfung des Hubwagens durch. Wählen Sie den Button <a href= "/faq/02/">"Abnehmen"</a> bei der Bestellposition aus, um im System den Wareneingang zu vermerken. Bei einer nicht erfolgreichen Qualitätsprüfung legen Sie außerdem eine <a href= "/faq/17/">Bestellreklamation</a> an.'                                                                                                                                                                                                                         , status_model = CustOrderDet.__name__      , task_model= CustOrderDet.__name__     , status=CustOrderDet.Status.GELIEFERT                          , view_url = 'cust_order_alter'        , view_kwargs_id = 'cust_order_id'      , group=Group.objects.get(name=K3))
        ...
        TaskType.objects.create(id=24   , title = "Bestellreklamation versenden"                , description ='Bitte versenden Sie die Bestellreklamation. Wählen Sie dafür den Button <a href= "/faq/25/">"An JOGA schicken"</a> aus. <a href= "/faq/4/">Scannen</a> Sie die den Barcode an dem Hubwagen und schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an den Kundendienst von JOGA, um ihn über die Bestellreklamation zu informieren. Dabei geben Sie den Barcode des Hubwagens an.'                                                                                                                           , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.REKLAMATION_FREIGEGEBEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K1)                          , status_for_all_details=True    , task_for_all_details=True)
        TaskType.objects.create(id=25   , title = "Bestellreklamation versenden"                , description ='Bitte versenden Sie die Bestellreklamation. Wählen Sie dafür den Button <a href= "/faq/25/">"An JOGA schicken"</a> aus. <a href= "/faq/4/">Scannen</a> Sie die den Barcode an dem Hubwagen und schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an den Kundendienst von JOGA, um ihn über die Bestellreklamation zu informieren. Dabei geben Sie den Barcode des Hubwagens an.'                                                                                                                           , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.REKLAMATION_FREIGEGEBEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K2)                          , status_for_all_details=True    , task_for_all_details=True)
        TaskType.objects.create(id=26   , title = "Bestellreklamation versenden"                , description ='Bitte versenden Sie die Bestellreklamation. Wählen Sie dafür den Button <a href= "/faq/25/">"An JOGA schicken"</a> aus. <a href= "/faq/4/">Scannen</a> Sie die den Barcode an dem Hubwagen und schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an den Kundendienst von JOGA, um ihn über die Bestellreklamation zu informieren. Dabei geben Sie den Barcode des Hubwagens an.'                                                                                                                           , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.REKLAMATION_FREIGEGEBEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=K3)                          , status_for_all_details=True    , task_for_all_details=True)
        TaskType.objects.create(id=27   , title = "Bestellreklamation an Produktion senden"     , description ='Bitte versenden Sie die den Hubwagen an die Produktion. Wählen Sie dafür den Button <a href= "/faq/18/">"An Produktion liefern"</a> und <a href= "/faq/4/">scannen</a> Sie den Barcode an dem Hubwagen.'                                                                                                                                                                                                                                                                                                     , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.REKLAMATION_FREIGEGEBEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=KUNDENDIENST)                , status_for_all_details=True    , task_for_all_details=True)
        ...
        TaskType.objects.create(id=29   , title = "Auftragsreklamation an KD senden"            , description ='Bitte senden Sie den verbesserten Hubwagen an den Kundendienst. Wählen Sie den Button <a href= "/faq/18/">"An Kundendienst senden"</a>aus und . <a href= "/faq/4/">scannen</a> Sie den Barcode an dem Hubwagen.'                                                                                                                                                                                                                                                                                             , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.ANPASSUNG_ABGESCHLOSSEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=PRODUKTION))
        TaskType.objects.create(id=30   , title = "Auftragsreklamation freigeben"                , description ='Bitte überprüfen Sie die <a href= "/faq/19/">Auftragsreklamation</a> und geben Sie diese frei.'                                                                                                                                                                                                                                                                                                                                                                                                             , status_model = CustComplaint.__name__     , task_model= CustComplaint.__name__    , status=CustComplaint.Status.ERFASST                           , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=KUNDENDIENST))
        ...
        TaskType.objects.create(id=32   , title = "Bestellreklamation an PDL senden"            , description ='Bitte senden Sie die Fehlteile an die Produktionsdienstleistung. Dafür wählen Sie den Button <a href= "/faq/23/">"Weiterleiten an PDL"</a> und <a href= "/faq/4/">scannen</a> anschließend den Barcode der Box ein.'                                                                                                                                                            , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTION))
        TaskType.objects.create(id=33   , title = "Alle reklamierten Positionen prüfen"         , description ='Bitte prüfen Sie alle Positionen der Bestellreklamation. Wenn keine Neulieferung von der Produktion erwünscht ist, dann wählen Sie den Button <a href= "/faq/24/">"Abschließen"</a>. Bei einer erwünschten Neulieferung der Teile wählen Sie den Button <a href= "/faq/24/">"Neu bestellen"</a> aus. Den Button <a href= "/faq/24/">"Aus Lager beliefern"</a> wählen Sie aus, wenn die Teile in ihrem Lager vorhanden sind und diese verwendet werden sollen. Hierfür müssen Sie eine manuelle <a href= "/faq/13/">"Lagerentnahme"</a> tätigen. Senden Sie außerordentlich eine Box an die Produktion. Dafür teilen Sie der Produktion die Boxnummer per <a href= "/faq/18/">Nachricht</a> mit. Nachdem alle Positionen bearbeitet wurden, wählen Sie den Button <a href= "/faq/23/">"Neubestellung auslösen"</a> oder den Button <a href= "/faq/23/">"Abschließen"</a>, wenn keine Neubestellung an den Lieferanten getätigt werden soll. Bei dem Button <a href= "/faq/23/">"Neubestellung auslösen"</a> legen Sie die Fehlteile, in eine Lieferantenbox und <a href= "/faq/4/">scannen</a> Sie die Boxnummer ein. Zum Schluss schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an den Lieferanten mit der Bestellraklamtion und der Boxnummer.'                                                                                                                                                                          , status_model = SuppComplaintDet.__name__  , task_model= SuppComplaint.__name__    , status=SuppComplaintDet.Status.REKLAMATION_FREIGEGEBEN        , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG)    , status_for_all_details=True)
        TaskType.objects.create(id=34   , title = "Reklamierte Teile an Produktion senden"      , description ='Bitte senden Sie die reklamierten Teile an das Team Produktion. Dafür wählen Sie den Button <a href= "/faq/23/">"An Produktion senden"</a> und legen die reklamierten Teile in eine Produktionsbox. Anschließend <a href= "/faq/4/">scannen</a> Siea den Barcode der Box ein.'                                                                                                                                                             , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG))
        ...
        #TaskType.objects.create(id=37   , title = "Bestellreklamation NEU"                      , description ="Bitte senden Sie die Neuteile an die JOGA. Schreiben Sie eine NAchricht mit der Boxnummer and die JOGA."                                                                                                                   , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L300))
        TaskType.objects.create(id=38   , title = "Bestellreklamation prüfen und freigeben"     , description ='Bitte prüfen Sie alle Positionen der <a href= "/faq/23/">Bestellreklamation</a> und geben Sie diese frei.'                                                                                                                                                    , status_model = SuppComplaintDet.__name__  , task_model= SuppComplaint.__name__    , status=SuppComplaintDet.Status.ERFASST                        , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG)    , status_for_all_details=True)
        ...
        TaskType.objects.create(id=40   , title = "Auftragsreklamation freigeben"               , description ='Bitte prüfen Sie alle Positionen der <a href= "/faq/20/">Auftragsreklamation</a> und geben Sie diese frei. Tipp: Denken Sie an die Boxnummer.'                                                                                                                                                                             , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L100))
        TaskType.objects.create(id=41   , title = "Auftragseklamation freigeben"                , description ='Bitte prüfen Sie alle Positionen der <a href= "/faq/20/">Auftragsreklamation</a> und geben Sie diese frei. Tipp: Denken Sie an die Boxnummer.'                                                                                                                                                                            , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L200))
        TaskType.objects.create(id=42   , title = "Auftragsreklamation freigeben"               , description ='Bitte prüfen Sie alle Positionen der <a href= "/faq/20/">Auftragsreklamation</a> und geben Sie diese frei. Tipp: Denken Sie an die Boxnummer.'                                                                                                                                                                             , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L300))
        TaskType.objects.create(id=43   , title = "Bestellreklamation freigeben"                , description ='Bitte prüfen Sie alle Positionen der <a href= "/faq/23/">Bestellreklamation</a> und geben Sie diese frei.'                                                                                                                                                                              , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTIONSDIENSTLEISTUNG))
        TaskType.objects.create(id=44   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. Wählen Sie den Button <a href= "/faq/20/">"Kunden beliefern"</a> um den Barcode der Box <a href= "/faq/4/">einzuscannen</a>. Anschließend komissionieren Sie die Teile. Schreiben Sie eine Nachricht an den Kunden mit der Boxnummer und <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann. Nachdem der Kunde beliefert wurde kann der Button <a href= "/faq/20/">"Abschließen"</a> ausgewählt werden, damit die Auftragsreklamation auf "Abgeschlossen" gesetzt wird.'                                                                       , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L100), status_for_all_details=True) 
        TaskType.objects.create(id=45   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. Wählen Sie den Button <a href= "/faq/20/">"Kunden beliefern"</a> um den Barcode der Box <a href= "/faq/4/">einzuscannen</a>. Anschließend komissionieren Sie die Teile. Schreiben Sie eine Nachricht an den Kunden mit der Boxnummer und <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann. Nachdem der Kunde beliefert wurde kann der Button <a href= "/faq/20/">"Abschließen"</a> ausgewählt werden, damit die Auftragsreklamation auf "Abgeschlossen" gesetzt wird.'                                                                    , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L200), status_for_all_details=True) 
        TaskType.objects.create(id=46   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. Wählen Sie den Button <a href= "/faq/20/">"Kunden beliefern"</a> um den Barcode der Box <a href= "/faq/4/">einzuscannen</a>. Anschließend komissionieren Sie die Teile. Schreiben Sie eine Nachricht an den Kunden mit der Boxnummer und <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann. Nachdem der Kunde beliefert wurde kann der Button <a href= "/faq/20/">"Abschließen"</a> ausgewählt werden, damit die Auftragsreklamation auf "Abgeschlossen" gesetzt wird.'                                                                      , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L300), status_for_all_details=True) 
        TaskType.objects.create(id=47   , title = "Bestellreklamation abgeschlossen"            , description ='Bitte montieren Sie die neugelieferten Teile. Sollte ein Teil erneut mangelhaft geliefert worden sein, so <a href= "/faq/22/">legen</a> Sie bitte eine neue Bestellreklamation an.'                                                , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=SuppComplaintDet.Status.ABGESCHLOSSEN                 , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=PRODUKTION))
        TaskType.objects.create(id=48   , title = "Bestand prüfen"                              , description ='Bitte führen Sie eine Bestandsprüfung durch. Wählen Sie dafür den Button <a href= "/faq/20/">"Bestandsprüfung"</a>. Wenn die Teile verfügbar sind, reservieren Sie diese.'                                                                                                                   , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L100))
        TaskType.objects.create(id=49   , title = "Bestand prüfen"                              , description ='Bitte führen Sie eine Bestandsprüfung durch. Wählen Sie dafür den Button <a href= "/faq/20/">"Bestandsprüfung"</a>. Wenn die Teile verfügbar sind, reservieren Sie diese.'                                                                                                                  , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L200))
        TaskType.objects.create(id=50   , title = "Bestand prüfen"                              , description ='Bitte führen Sie eine Bestandsprüfung durch. Wählen Sie dafür den Button <a href= "/faq/20/">"Bestandsprüfung"</a>. Wenn die Teile verfügbar sind, reservieren Sie diese.'                                                                                                                  , status_model = SuppComplaint.__name__     , task_model= SuppComplaint.__name__    , status=-1                                                     , view_url = 'supp_complaint_alter'    , view_kwargs_id = 'supp_complaint_id'  , group=Group.objects.get(name=L300))
