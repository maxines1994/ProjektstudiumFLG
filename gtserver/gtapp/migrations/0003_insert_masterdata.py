...
class Migration(migrations.Migration):
    ...
    def insert_tasktypes(apps, schema_editor):
        ...
        TaskType.objects.create(id=29   , title = "Auftragsreklamation an Kundendienst senden"  , description ='Bitte senden Sie den verbesserten Hubwagen an den Kundendienst. Wählen Sie den Button <a href= "/faq/18/">"An Kundendienst senden"</a>aus und . <a href= "/faq/3/">scannen</a> Sie den Barcode an dem Hubwagen.'                                                                                                                                                                                                                                                                                             , status_model = CustComplaintDet.__name__  , task_model= CustComplaintDet.__name__ , status=CustComplaintDet.Status.ANPASSUNG_ABGESCHLOSSEN        , view_url = 'cust_complaint_alter'    , view_kwargs_id = 'cust_complaint_id'  , group=Group.objects.get(name=PRODUKTION))
        ...
        TaskType.objects.create(id=44   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. <a href= "/faq/3/">Scannen</a> Sie dafür den Barcode und <a href= "/faq/15/">kommissionieren</a> Sie die reklamierten Teile. Schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an die Produktionsdienstleistung des Kunden, welche Reklamation sich in welcher Box befindet. Denken Sie an die <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann.'                                                                       , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L100), status_for_all_details=True) 
        TaskType.objects.create(id=45   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. <a href= "/faq/3/">Scannen</a> Sie dafür den Barcode und <a href= "/faq/15/">kommissionieren</a> Sie die reklamierten Teile. Schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an die Produktionsdienstleistung des Kunden, welche Reklamation sich in welcher Box befindet. Denken Sie an die <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann.'                                                                       , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L200), status_for_all_details=True) 
        TaskType.objects.create(id=46   , title = "Kunden beliefern"                            , description ='Bitte beliefern Sie den Kunden. <a href= "/faq/3/">Scannen</a> Sie dafür den Barcode und <a href= "/faq/15/">kommissionieren</a> Sie die reklamierten Teile. Schreiben Sie eine <a href= "/faq/1/">Nachricht</a> an die Produktionsdienstleistung des Kunden, welche Reklamation sich in welcher Box befindet. Denken Sie an die <a href= "/faq/28/">Referenznummer</a>, damit der Kunde die Reklamation in seinem System zuweisen kann.'                                                                       , status_model = SuppComplaintDet.__name__         , task_model= SuppComplaint.__name__        , status=SuppComplaintDet.Status.BESTANDSPRUEFUNG_ABGESCHLOSSEN          , view_url = 'supp_complaint_alter'        , view_kwargs_id = 'supp_complaint_id'      , group=Group.objects.get(name=L300), status_for_all_details=True) 
