...
class Migration(migrations.Migration):
    ...
    def insert_parts(apps, schema_editor):
        ...
        Part.objects.create(supplier=supplier_L100, part_no='T3', description='Strebe 230', pack_quantity=8, install_quantity=4, initial_stock=5, total_stock=40, image='img/parts/03.png')
        Part.objects.create(supplier=supplier_L100, part_no='T4', description='Strebe 280', pack_quantity=8, install_quantity=4, initial_stock=2, total_stock=40, image='img/parts/03.png')
        ...
        Part.objects.create(supplier=supplier_L200, part_no='T6', description='Hülse Hubelement', pack_quantity=10, install_quantity=2, initial_stock=0, total_stock=50, image='img/parts/13.png')
        ...
        Part.objects.create(supplier=supplier_L300, part_no='T12', description='Querstrebe 120', pack_quantity=8, install_quantity=4, initial_stock=2, total_stock=40, image='img/parts/06.png')
        Part.objects.create(supplier=supplier_L300, part_no='T13', description='Querstrebe 170', pack_quantity=6, install_quantity=4, initial_stock=2, total_stock=40, image='img/parts/06.png')
