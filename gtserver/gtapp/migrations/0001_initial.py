# Generated by Django 3.1.2 on 2020-12-06 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_creation_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orgaunit_creation_user', to=settings.AUTH_USER_MODEL)),
                ('_update_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orgaunit_update_user', to=settings.AUTH_USER_MODEL)),
