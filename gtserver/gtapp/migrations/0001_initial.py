# Generated by Django 3.1.4 on 2021-02-01 15:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_no', models.CharField(blank=True, max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True)),
                ('box_no', models.CharField(blank=True, max_length=10, null=True)),
                ('status', models.CharField(choices=[('0', 'Standard'), ('1', 'Erfasst'), ('2', 'Bestandsprüfung ausstehend'), ('3', 'Auftrag freigegeben'), ('4', 'In Produktion'), ('5', 'Lieferung an Kundendienst ausstehend'), ('6', 'Lieferung an Kunden ausstehend'), ('7', 'Geliefert'), ('8', 'Reklamiert'), ('9', 'Bestellt')], default='0', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_system', models.BooleanField(default=False)),
                ('box_no', models.CharField(blank=True, max_length=8, null=True)),
                ('status', models.CharField(choices=[('0', 'Standard'), ('1', 'Erfasst'), ('2', 'Bestandsprüfung ausstehend'), ('3', 'Lieferung an JOGA ausstehend'), ('4', 'Geliefert'), ('5', 'Bestellt')], default='0', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supp_order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gtapp.supporder')),
                ('supp_order_det', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gtapp.supporderdet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trash', models.IntegerField(blank=True, default=0, null=True, verbose_name='Davon fehlerhaft')),
                ('_creation_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='goods_receipt_creation_user', to=settings.AUTH_USER_MODEL)),
                ('_update_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='goods_receipt_update_user', to=settings.AUTH_USER_MODEL)),
                ('cust_complaint_det', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gtapp.custcomplaintdet', verbose_name='Ware')),
                ('cust_det', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gtapp.custorderdet', verbose_name='Ware')),
                ('supp_complaint_det', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gtapp.suppcomplaintdet', verbose_name='Ware')),
                ('supp_det', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='gtapp.supporderdet', verbose_name='Ware')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='custcomplaintdet',
            name='cust_order_det',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gtapp.custorderdet'),
        ),
        migrations.AddField(
