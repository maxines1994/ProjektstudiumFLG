# Generated by Django 3.1.4 on 2020-12-19 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='child_todo', to='gtapp.todotype')),
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auth.group')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='parent_todo', to='gtapp.todotype')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_creation_date', models.DateTimeField(auto_now_add=True)),
                ('_update_date', models.DateTimeField(auto_now=True)),
                ('template_type', models.CharField(max_length=3)),
                ('description_en', models.CharField(max_length=100)),
                ('description_de', models.CharField(max_length=100)),
                ('_creation_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='templatetype_creation_user', to=settings.AUTH_USER_MODEL)),
                ('_update_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='templatetype_update_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gtapp.status')),
                ('template_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gtapp.templatetype')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField()),
                ('subject', models.CharField(max_length=100)),
                ('sent_on', models.SmallIntegerField(default=1)),
                ('received_on', models.SmallIntegerField(default=1)),
                ('read_on', models.SmallIntegerField(default=1)),
                ...
                ('receiver', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='receiver', to=settings.AUTH_USER_MODEL)),
                ...
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gtapp.status')),
                ('template', models.ForeignKey(default=-1, on_delete=django.db.models.deletion.SET_DEFAULT, to='gtapp.messagetemplate')),
            ],
            options={
                'abstract': False,
            },
