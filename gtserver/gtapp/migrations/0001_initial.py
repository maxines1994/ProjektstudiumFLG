    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('0', 'Standard'), ('1', 'Bestandsreservierung ausstehend'), ('2', 'Freigegeben'), ('3', 'Materialbereitstellung ausstehend'), ('4', 'Wird produziert'), ('5', 'Lieferung an Kundendienst ausstehend'), ('6', 'Lieferung an Kunden ausstehend'), ('7', 'Geliefert')], default='0', max_length=1)),
