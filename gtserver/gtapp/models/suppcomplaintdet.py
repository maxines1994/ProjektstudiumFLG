...
class SuppComplaintDet(ComplaintDet):
    ...
    class Status(models.TextChoices):       
        ERFASST                         = '0', ('Erfasst|'+ PRODUKTION +','+ PRODUKTIONSDIENSTLEISTUNG +','+ LIEFERANTEN +'|0%')
        VERSAND_AN_PDL                  = '1', ('Versandt an PDL|'+ PRODUKTIONSDIENSTLEISTUNG +'|10%')
        IN_BEARBEITUNG                  = '2', ('In Bearbeitung|'+ PRODUKTIONSDIENSTLEISTUNG +'|20%')
        REKLAMATION_FREIGEGEBEN         = '3', ('Reklamation freigegeben|'+ PRODUKTIONSDIENSTLEISTUNG +','+ LIEFERANTEN +'|30%')
